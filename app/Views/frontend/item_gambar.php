              ...
              <div class="col-12 grid-margin">
                <div class="card mb-3">
                  <div class="card-body p-4">
                    <h1 class="card-title">Setting Frontend</h1>
                    <!-- breadcum -->
                    <div aria-label="breadcrumb border-0">
                      <ol class="breadcrumb border-0 p-0">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#">Setting</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Item Gambar</li>
                      </ol>
                    </div>
                    <!-- end breadcum -->
                ...
                <div class="card pl-2">
                  <div class="card-body">
                    <div class="row">
                            <div class="col-lg-2">
                              <a href="<?= site_url('SettingController/create') ?>" class="btn btn-primary btn-md form-control"><i class="mdi mdi-plus menu-icon"></i><i class="mdi mdi-account menu-icon"></i></a>
                                </div>
                                  <div class="col-lg-10">
                                </div>
                        </div>
                    ...
                    <div style="margin-left:30px;">
                      <table class="ui celled table text-center" style="width:100%" id="DataT">
                        ...
                        foreach($slider as $row) :?>
                                <tr>
                                <td><?= $i++?></td>
                                <td><img src="<?= base_url()?>/assets/images/produk_foto/<?= $row->slider1;?>"> </td>
                                <td><img src="<?= base_url()?>/assets/images/produk_foto/<?= $row->slider2;?>"> </td>
                                <td><img src="<?= base_url()?>/assets/images/produk_foto/<?= $row->slider3;?>"> </td>
                                <td><img src="<?= base_url()?>/assets/images/card/<?= $row->card1;?>"> </td>
                                <td><img src="<?= base_url()?>/assets/images/card/<?= $row->card2;?>"> </td>
                                <td><img src="<?= base_url()?>/assets/images/card/<?= $row->card3;?>"> </td>
                                 <td>
