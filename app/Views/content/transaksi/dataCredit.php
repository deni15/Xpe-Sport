              ...
              <div class="col-12 grid-margin">
                <div class="card mb-3">
                  <div class="card-body p-4">
                    <h1 class="card-title">Data Transaksi Credit</h1>
                    <!-- breadcum -->
                    <div aria-label="breadcrumb border-0">
                      <ol class="breadcrumb border-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="<?php base_url()?>/TransaksiController">List Transaksi Credit</a></li>
                      </ol>
                    </div>
                    <!-- end breadcum -->
